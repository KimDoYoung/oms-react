...
- 주문관리시스템(OMS)을 React, Sprintboot 로 개발한다.
- backend/frontend로 폴더를 나누어서 관리함. backend는 springboot, frontend는 react로 개발
...
## 실행
- bm.sh : backend 실행과 관련된 명령어들 모음.
- fm.sh : frontend 실행과 관련된 명령어들 모음.
